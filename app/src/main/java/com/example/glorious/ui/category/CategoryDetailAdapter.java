...
public class CategoryDetailAdapter extends RecyclerView.Adapter<CategoryDetailAdapter.RecyclerViewHolder> {
    ArrayList<ProductData> productData;
    Context context;
    private ArrayList<ProductData> searchData;

    public CategoryDetailAdapter(Context co, ArrayList<ProductData> mCustomerList) {
        this.context = co;
    ...
    @NonNull
    @Override
    public CategoryDetailAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.datadaptorrecycler, parent, false);
        return new RecyclerViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryDetailAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.tvprice.setText("MRP ₹"+dateDatas.productPrice);
